...
{
    public class ExpertConsultantsController : Controller
    {
        private OrcaContext db = new OrcaContext();

        // GET: ExpertConsultants
        ...
        // GET: ExpertConsultants/Details/5
        ...
        // POST: ExpertConsultants/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "OrcaUserID,ExpertStatus,IsActive")] ExpertConsultant expertConsultant)
        {
        ...
        // POST: ExpertConsultants/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrcaUserID,ExpertStatus,IsActive")] ExpertConsultant expertConsultant)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: ExpertConsultants/Delete/5
        ...
        // POST: ExpertConsultants/Delete/5
